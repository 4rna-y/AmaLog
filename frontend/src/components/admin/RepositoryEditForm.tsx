...
const RepositoryEditForm: React.FC<RepositoryEditFormProps> = ({ repository }) => {
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mb-2">
                            ...
                            />
                            <TUIButton onClick={handleAddLang} variant="underlined" className="text-foreground-light">
                                Add
                            </TUIButton>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            {langs.map((lang, index) => (
                                <span
                                    ...
                                    #{lang}
                                    <TUIButton onClick={() => handleRemoveLang(index)} variant="underlined" className="text-foreground-light hover:text-red-400">
                                        x
                                    </TUIButton>
                                </span>
                            ))}
                ...
                <div>
                    <div className="sticky top-8">
                        ...
                        <div className="bg-background-light border border-foreground-dark/20 rounded-lg p-6">
                            <h1 className="text-3xl font-bold text-foreground-light mb-4">{name}</h1>
            ...
            <div className="flex gap-4 pt-6 border-t border-foreground-dark/20">
                ...
                <TUIButton onClick={() => router.push("/admin/dashboard/repository")} variant="underlined" className="text-foreground-light">
                    Cancel
                </TUIButton>
            </div>
        </div>
